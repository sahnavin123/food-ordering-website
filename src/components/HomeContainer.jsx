  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full ' id='home'>
      <div className=' py-2 flex-1 flex flex-col items-start justify-center  gap-6'>
        ...
        >The Fastest Delivery in <span className='text-orange-600 text-[3rem] md:text-[4rem]'>Your City</span></p>

        <p className='text-base text-textColor text-center md:text-left md:w-[80%] '>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas explicabo, necessitatibus modi iusto, numquam commodi ex quisquam optio, fugit eius veniam eligendi aliquid magni impedit facere eos consequatur in doloribus?</p>
      ...
      <div className=' py-2 flex-1 flex items-center relative '>
          ...
          <img src={HeroBg} alt="hero-Bg" className=' h-420 w-full lg:w-auto lg:h-650 ml-auto' />

          <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center py-4 gap-4 flex-wrap lg:px-32">
            {heroData && heroData.map(n =>(
              <div key={n.id} className='  lg:w-190  p-4  bg-cardOverlay backdrop-blur-md rounded-3xl flex items-center justify-cente flex-col drop-shadow-lg '>
